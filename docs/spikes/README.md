...
| 14 | A tray icon on the common Linux desktops | partial — Ubuntu GNOME/Wayland verified | [08](08-linux-desktop.md) |
| 15 | Returning to a session on Linux (X11 and Wayland) | done for X11 | [08](08-linux-desktop.md) |
