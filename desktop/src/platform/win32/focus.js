...
// Windows can always ask. Whether a given process turns out to have a window is
// answered per click, not up front — the counterpart on Linux cannot say even
// that much, because a Wayland session forbids the question entirely.
function focusCapability() {
  return { available: true, reason: null };
}

module.exports = { focusProcessWindow, focusCapability };
